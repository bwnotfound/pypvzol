...
TODO: 
1. 自动复合那里加上6本高级品刷的数量，便于展示
2. 服务器更新和readtimeout等待次数改为无限
3. 全自动开魔神箱子提供自动填入需要多少魔神
4. 全自动添加指定周期数
5.  优先：领地添加服务器查询选项，提供每个区打领地情况查询，有人打领地的区可以选择是否等候，同时通过轮询提供实时挑战列表。服务器实现排班，一个人一直打就切下来换下一个人打，同时扔进队列较前面。
6.  优先：领地添加多线程
